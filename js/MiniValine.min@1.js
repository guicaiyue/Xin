  ...
  return function(e) {
      ...
      e.exports = function(e) {
          e.nestQuery = function(t) {
              e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mail, mailMd5, ua from Comment where rid in (".concat(JSON.stringify(t).replace(/(\[|\])/g, ""), ") order by -createdAt")).then((function(t) {
      ...
      e.exports = function(e) {
          ...
          e.parentCount = 0, e.parentQuery = function() {
              ...
              e.loading.show(), e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mail, mailMd5, ua from Comment where (rid='' or rid is not exists) and url='".concat(e.C.url, "' order by -createdAt limit ").concat((n - 1) * e.pageSize, ",").concat(e.pageSize)).then((function(r) {
      ...
      e.exports = function(e) {
          ! function(e) {
              ...
              t && !t.classList.contains("loaded") && AV.Query.doCloudQuery("select nick, mail, comment, url from Comment where (rid='' or rid is not exists) order by -createdAt limit 0,10").then((function(n) {
                  ...
                  if (i) {
                      for (var r = "", o = 0; o < i; o++) r += '<li class="item"><a href="/' + n[o].get("url") + "#" + n[o].id + '"><span class="breadcrumb">' + n[o].get("nick") + " @ " + (0, a.default)(n[o].get("createdAt"), e.i18n) + "</span><span>" + n[o].get("comment").replace(/<[^>]+>/gi, "").substr(0, 100) + "</span></a></li>";
